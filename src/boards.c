...
{ {250, LVL_IMMORT, LVL_IMMORT, LVL_GOD, LIB_ETC "board.immort", 0},
  {251, 0, 0, LVL_IMMORT, LIB_ETC "board.newbie", 0},
  {252, 0, 0, LVL_IMMORT, LIB_ETC "board.newbie", 0},
  {253, 0, 0, LVL_IMMORT, LIB_ETC "board.newbie", 0},
  {254, 0, 0, LVL_IMMORT, LIB_ETC "board.newbie", 0},
...
int Board_show_board(int board_type, struct char_data * ch, char *arg, struct obj_data *board)
{
  ...
  strcpy(buf,
         "Это доска, на которой всякие разные личности оставили свои IHHO.\r\n"
         " Формат: ЧИТАТЬ/ОЧИСТИТЬ <номер письма>, ПИСАТЬ <кому>.\r\n");
