...
void load_banned(void)
{
  FILE *fl;
  int i, date;
  char site_name[BANNED_SITE_LENGTH + 1], ban_type[100], metter[MAX_STRING_LENGTH];
...
ACMD(do_ban)
{
  char flag[MAX_INPUT_LENGTH], site[MAX_INPUT_LENGTH],
       format[MAX_INPUT_LENGTH], metter[MAX_INPUT_LENGTH], *nextchar, *timestr;
  int i;
